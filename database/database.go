...
func (d Database) CreateTables() {
	statements := []string{
		...
		"CREATE TABLE IF NOT EXISTS reservations (id FLOAT NOT NULL, groupID FLOAT NOT NULL, timetableID VARCHAR(14) NOT NULL, participant VARCHAR(8) NOT NULL, date DATETIME NOT NULL, priority_level FLOAT NOT NULL, priority_description TEXT NOT NULL, ipad_group FLOAT NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, PRIMARY KEY (id))",
